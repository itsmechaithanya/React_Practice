...
function Cardss({user,handleRemove,id}) {
  return (
    <>
          <div className='h-full w-44 bg-rose-400 rounded-lg flex flex-col items-center p-2'>
            ...
            <button onClick={()=>handleRemove(id)} className=' capitalize bg-rose-900 text-white px-3 py-1 mt-5 rounded-full'>remove it</button>
        </div>
